...
Util.buildInvDetail = async function(data){
  ...
  if(data.length > 0){
    ...
    details += '<img src="' + car.inv_image + '" alt="image of ' + car.inv_make + ' ' + car.inv_model + '"/>'
    let list = '<ul class="description-list">'
    list+= '<li>' + car.inv_description + '</li>'
    list+= '<li> Color: ' + car.inv_color + '</li>'
    list+= '<li> Price: $' + parseInt(car.inv_price, 10).toLocaleString("en-US") + '</li>'
    list+= '<li> Mileage: ' + car.inv_miles.toLocaleString("en-US") + '</li>'
